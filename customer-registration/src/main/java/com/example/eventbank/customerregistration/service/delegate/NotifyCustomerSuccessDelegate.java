...
@Service("NotifyCustomerSuccessDelegate")
@Slf4j
@RequiredArgsConstructor
public class NotifyCustomerSuccessDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        EmailNotificationEvent emailNotificationEvent = new EmailNotificationEvent(
                ...
                "Welcome to EventBank",
                "Dear " + delegateExecution.getVariable("lastName") + ", \n" +
                        "your account was successfully opened. Welcome to EventBank!"
        );
